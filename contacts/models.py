...
class InteractionType(enum.Enum):
    other = enum.Item(0, 'Other')
    other = enum.Item(0, 'Other')
    phone_call = enum.Item(1, 'Phone call')
    email = enum.Item(2, 'Email')
    donation = enum.Item(3, 'Donation')
    purchase = enum.Item(4, 'Purchase')
    subscription_start = enum.Item(5, 'Subscription Start')
    subscription_end = enum.Item(6, 'Subscription End')
...
class Interaction(models.Model):
    ...
    category = models.IntegerField(choices=InteractionType, default=InteractionType.other)
